...
- Story 2.2 routing is built on branch `claude/story-2-2-routing` and is in a pull request awaiting Preview acceptance, merge and a green Production deployment. The local suite passes 110 tests. All 14 fixture 31 decisions match `expected_routing.json` v1.0. The run manifest schema is 1.5 and the confidential bundle schema is 1.2. Preview and Production checks have not yet run for this story.
